...
# ==========================================================================
with tab_aug:
    st.subheader("📅 직전(7~8월) 금통위 예측 결과 및 백테스트 성적표")
    
    col_acc1, col_acc2, col_acc3 = st.columns(3)
    col_acc1.metric("테스트 회의 건수", "83건 (2022~2026)")
    col_acc2.metric("최종 정상 정확도 (Accuracy)", "80.72%")
    col_acc3.metric("동결 예측 F1-Score", "0.89")
    
    st.markdown("""
    > **직전 7~8월 인상 사이클 검증:**
    > 2026년 7월 23일 회의 직전, 채권 시장 호가와 유가 급등을 반영하여 AI 모델이 **인상 확률 51.9%**를 도출하였고,
    > 실제로 한국은행은 기준금리를 **2.75%에서 3.00%로 25bp 인상** 단행하며 예측이 정확히 적중했습니다.
    """)
